...
In flexible mode, first, calculate unsigned differences for each point that can receive ease of stay value. Then, sum them and substruct the sum by each difference. In addition, sum them and divide the differences by the sum. Finally, multiply the center value.
